...
func TestShorten(t *testing.T) {
	shortenTests := []struct {
		...
		{"github.com/barista-run/barista.Run", "barista:Run"},
		{"github.com/barista-run/barista.(*i3Bar).AddModule",
			"barista:i3Bar.AddModule"},
		{"github.com/barista-run/barista/modules/weather/darksky.(*Provider).GetWeather",
			"mod:weather/darksky.Provider.GetWeather"},
		{"github.com/barista-run/barista/modules/clock", "mod:clock"},
		{"github.com/barista-run/barista/core.Module", "core:Module"},
		{"github.com/barista-run/barista/value.(Value).Set", "bar:value.Value.Set"},
